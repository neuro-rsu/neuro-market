...
import DataSet from './my-sportsman-dataset.mjs'
//import SportsmenDataSet from './my-sportsmen/my-sportsmen-dataset.mjs'
import DataSource from './my-sportsman-datasource.mjs'

class MySportsmanSection1 extends BaseElement {
    ...
    #page1() {
        return html`
            <my-sportsman-section-1-page-1 .oldValues=${this.oldValues} .item=${this.currentItem}></my-sportsman-section-1-page-1>
        `;
    }

    #page2() {
        return html`
            <my-sportsman-section-1-page-2 .oldValues=${this.oldValues} .item=${this.currentItem}></my-sportsman-section-1-page-2>
        `;
    }
    ...
    #list2() {
        return html`
            <my-sportsman-section-1-list-2 .parent=${this.currentItem}></my-sportsman-section-1-list-2>
        `;
    }
...
customElements.define("my-sportsman-section-1", MySportsmanSection1);