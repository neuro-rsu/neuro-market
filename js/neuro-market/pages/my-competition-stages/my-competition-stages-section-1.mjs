...
import './my-competition-stages-section-1-page-1.mjs'

import DataSet from './my-competition-stages-dataset.mjs'
import DataSource from './my-competition-stages-datasource.mjs'

class MyCompetitionStagesSection1 extends BaseElement {
    ...
    update(changedProps) {
        ...
        if (changedProps.has('currentCompetitionStagesItem')) {
            this.currentPage = 0;
        }
    }
    ...
    #page1() {
        return html`
            <my-competition-stages-section-1-page-1 .oldValues=${this.oldValues} .item=${this.currentItem}></my-competition-stages-section-1-page-1>
        `;
    }

    #page2() {
        return html`
            <my-competition-stages-section-1-page-2 .item=${this.currentItem}></my-competition-stages-section-1-page-2>
        `;
    }
    ...
    render() {
        return html`
            ...
            <header class="left-header"><p>${lang`Competition stages`}</p></header>
...
customElements.define("my-competition-stages-section-1", MyCompetitionStagesSection1);