    ...
    render() {
        return html`
            <div class="container">
                ...
                <simple-input id="shortName" icon-name="referee-short-category-solid" label="${lang`Short name`}:" .value=${this.item?.shortName} @input=${this.validateInput}></simple-input>
            </div>
        `;
    }
...
customElements.define("my-referee-categories-section-1-page-1", MyRefereeCategoriesSection1Page1);