...
class MyRefereeCategoriesSection1 extends BaseElement {
    ...
    #page1() {
        return html`
            <my-referee-categories-section-1-page-1 .oldValues=${this.oldValues} .item=${this.currentItem}></my-referee-categories-section-1-page-1>
        `;
    }

    #page2() {
        return html`
            <my-referee-categories-section-1-page-2 .item=${this.currentItem}></my-referee-categories-section-1-page-2>
        `;
    }
    ...
    render() {
        return html`
            ...
            <header class="left-header"><p>${lang`Referee categories`}</p></header>
...
customElements.define("my-referee-categories-section-1", MyRefereeCategoriesSection1);