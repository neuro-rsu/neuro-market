...
class MyCompetitionSection2Page7 extends BaseElement {
    ...
    render() {
        return html`
            ...
            <div class="container">
                ...
                <div class="name-group">
                    <simple-input id="result" icon-name="timer-solid" label="${lang`Result`}:" .currentObject=${this.item?.sprinting} .value=${this.item?.sprinting?.result} @input=${this.validateInput}></simple-input>
...
customElements.define("my-competition-section-2-page-7", MyCompetitionSection2Page7);