...
class MyCompetitionSection6Table4 extends BaseElement {
    ...
    const docInfo = {
        ...
        content: [
            ...
            {
                text: "Итоговый протокол по плаванию",
                fontSize: 14,
                bold: true,
                alignment: "center",
                margin: [0, 6, 0, 10],
...
customElements.define("my-competition-section-6-table-4", MyCompetitionSection6Table4);