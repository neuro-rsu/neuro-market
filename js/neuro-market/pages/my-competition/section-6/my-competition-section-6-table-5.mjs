...
class MyCompetitionSection6Table5 extends BaseElement {
    ...
    const docInfo = {
        ...
        content: [
            ...
            {
                text: "Итоговый протокол по метанию",
                fontSize: 14,
                bold: true,
                alignment: "center",
                margin: [0, 6, 0, 10],
...
customElements.define("my-competition-section-6-table-5", MyCompetitionSection6Table5);