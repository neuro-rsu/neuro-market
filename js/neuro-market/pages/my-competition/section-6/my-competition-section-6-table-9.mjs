...
class MyCompetitionSection6Table9 extends BaseElement {
    ...
    const docInfo = {
        ...
        content: [
            ...
            {
                text: "Итоговый протокол по лыжероллерной гонке",
                fontSize: 14,
                bold: true,
                alignment: "center",
                margin: [0, 6, 0, 10],
...
customElements.define("my-competition-section-6-table-9", MyCompetitionSection6Table9);