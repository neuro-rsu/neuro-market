...
class MyCompetitionSection6Table7 extends BaseElement {
    ...
    const docInfo = {
        ...
        content: [
            ...
            {
                text: "Итоговый протокол по бегу",
                fontSize: 14,
                bold: true,
                alignment: "center",
                margin: [0, 6, 0, 10],
...
customElements.define("my-competition-section-6-table-7", MyCompetitionSection6Table7);