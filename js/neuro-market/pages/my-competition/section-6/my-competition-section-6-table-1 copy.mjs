...
class MyCompetitionSection6Table1 extends BaseElement {
    ...
    const tableBody = [
        [
            ...
            { text: 'Спортсмен', rowSpan: 2, fontSize: 10, fillColor: '#d7e1b9', alignment: "center", margin: [0, 0, 0, 0] },
            { text: 'Раз\nряд', rowSpan: 2, fontSize: 10, fillColor: '#d7e1b9', alignment: "center", margin: [0, 0, 0, 0] },
            { text: 'Дата рожд.', rowSpan: 2, fontSize: 10, fillColor: '#d7e1b9', alignment: "center", margin: [0, 0, 0, 0] },
            { text: 'Субъект РФ', rowSpan: 2, fontSize: 10, fillColor: '#d7e1b9', alignment: "center", margin: [0, 0, 0, 0] },
            { text: 'Спортивный клуб', rowSpan: 2, fontSize: 10, fillColor: '#d7e1b9', alignment: "center", margin: [0, 0, 0, 0] },
            ...
            { text: 'Очки', rowSpan: 2, fontSize: 10, fillColor: '#d7e1b9', alignment: "center", margin: [0, 0, 0, 0] },
        ],
        [
            '', '', '', '', '', '', '', '', ''
    ...
    const docInfo = {
        ...
        content: [
            ...
            {
                text: "Итоговый протокол по стрельбе",
                fontSize: 14,
                bold: true,
                alignment: "center",
                margin: [0, 6, 0, 10],
            },
            {
                table: {
                    ...
                    widths: [7*dot, '*', 6*dot, 16*dot, 30*dot, 30*dot, 9*dot, 9*dot, 9*dot],
...
customElements.define("my-competition-section-6-table-1", MyCompetitionSection6Table1);