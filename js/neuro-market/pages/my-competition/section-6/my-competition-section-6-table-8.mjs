...
class MyCompetitionSection6Table8 extends BaseElement {
    ...
    const docInfo = {
        ...
        content: [
            ...
            {
                text: "Итоговый протокол по лыжной гонке",
                fontSize: 14,
                bold: true,
                alignment: "center",
                margin: [0, 6, 0, 10],
            },
            {
                table: {
                    ...
                    widths: [7*dot, '*', 12*dot, 16*dot, 40*dot, '*', 9*dot, 15*dot, 9*dot],
...
customElements.define("my-competition-section-6-table-8", MyCompetitionSection6Table8);