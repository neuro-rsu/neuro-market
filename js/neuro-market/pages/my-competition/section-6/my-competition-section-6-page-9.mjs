...
import { rollerSkiingMask } from './masks.mjs'
import { isRollerSkiingValid } from './validation.mjs'
...
customElements.define("my-competition-section-6-page-9", MyCompetitionSection6Page9);