...
import DataSource from './my-competition-kinds-datasource.mjs'

class MyCompetitionKindsSection1 extends BaseElement {
    ...
    update(changedProps) {
        ...
        if (changedProps.has('currentCompetitionKindsItem')) {
            this.currentPage = 0;
        }
    }
    ...
    #page1() {
        return html`
            <my-competition-kinds-section-1-page-1 .oldValues=${this.oldValues} .item=${this.currentItem}></my-competition-kinds-section-1-page-1>
        `;
    }

    #page2() {
        return html`
            <my-competition-kinds-section-1-page-2 .item=${this.currentItem}></my-competition-kinds-section-1-page-2>
        `;
    }
    ...
    render() {
        return html`
            ...
            <header class="left-header"><p>Competition kinds</p></header>
...
customElements.define("my-competition-kinds-section-1", MyCompetitionKindsSection1);