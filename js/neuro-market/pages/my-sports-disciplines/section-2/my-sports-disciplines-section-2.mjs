...
import DataSet from './my-sports-disciplines-section-2-dataset.mjs'
import DataSource from './my-sports-disciplines-section-2-datasource.mjs'

// import CompetitionDataSource from '../section-1/my-competition-datasource.mjs'

class MySportsDisciplinesSection2 extends BaseElement {
    ...
    #page1() {
        return html`
            <my-sports-disciplines-section-2-page-1 .parent=${this.parent} .oldValues=${this.oldValues} .item=${this.currentItem}></my-sports-disciplines-section-2-page-1>
        `;
    }

    #page2() {
        return html`
            <my-sports-disciplines-section-2-page-1 .item=${this.currentItem}></my-sports-disciplines-section-2-page-1>
        `;
    }
    ...
    #list3() {
        return html`
            <my-sports-disciplines-section-2-list-1 .parent=${this.currentItem}></my-sports-disciplines-section-2-list-3>
        `;
    }

    get #list() {
        switch(this.currentPage) {
            case 0: return this.#list1()
    ...
    gotoPage(index) {
        if (index !== 1) {
            this.parentNode.host.currentSection = 0
    ...
    async firstUpdated() {
        ...
        const parentId = sessionStorage.getItem('currentSportsDiscipline').split(':')[1]
        this.dataSource = new DataSource(this, await DataSet.getDataSet(parentId))
    }
}

customElements.define("my-sports-disciplines-section-2", MySportsDisciplinesSection2);