...
class MySportsmenSection1Page3 extends BaseElement {
    ...
    render() {
        return html`
            <div class="container">
                <simple-input id="lastName" label="${lang`Last name`}:" icon-name="user" .value=${this.item?.lastName} @input=${this.validateInput} button-name="filter-solid" @button-click=${this.search} @keydown=${this.searchClick}></simple-input>
...
customElements.define("my-sportsmen-section-1-page-3", MySportsmenSection1Page3);