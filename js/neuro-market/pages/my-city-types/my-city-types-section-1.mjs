...
import './my-city-types-section-1-page-1.mjs'

import DataSet from './my-city-types-dataset.mjs'
import DataSource from './my-city-types-datasource.mjs'

class MyCityTypesSection1 extends BaseElement {
    ...
    update(changedProps) {
        ...
        if (changedProps.has('currentCityTypeItem')) {
            this.currentPage = 0;
        }
    }
    ...
    #page1() {
        return html`
            <my-city-types-section-1-page-1 .oldValues=${this.oldValues} .item=${this.currentItem}></my-city-types-section-1-page-1>
        `;
    }

    #page2() {
        return html`
            <my-city-types-section-1-page-2 .item=${this.currentItem}></my-city-types-section-1-page-2>
        `;
    }
    ...
    render() {
        return html`
            ...
            <header class="left-header"><p>${lang`City types`}</p></header>
...
customElements.define("my-city-types-section-1", MyCityTypesSection1)