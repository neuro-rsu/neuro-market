const dictionary = {
    ...
    'Your happiness is already here': {
        "ru-RU": 'Ваше счастью уже здесь',
        "en-EN": 'Your happiness is already here'
    },
    'Find your neural network!': {
        "ru-RU": 'Найдите свою нейросеть',
        "en-EN": 'Find your neural network!'
    },
    'Learn more': {
        "ru-RU": 'Узнать больше',
        "en-EN": 'Learn more'
    ...
    '© Ryazan State University named after S.A. Yesenin': {
        "ru-RU": '© Рязанский государственный университет имени С.А. Есенина',
        "en-EN": '© Ryazan State University named after S.A. Yesenin'
    },
    'Discipline groups': {
